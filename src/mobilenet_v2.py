...
def relu6(x):
    """Relu 6
    """
    return KerasBackend.relu(x, max_value=6.0)
...
def _conv_block(inputs, filters, kernel, strides):
    ...
    channel_axis = 1 if KerasBackend.image_data_format() == 'channels_first' else -1
...
def _bottleneck(inputs, filters, kernel, t, alpha, s, r=False):
    ...
    channel_axis = 1 if KerasBackend.image_data_format() == 'channels_first' else -1
    # Depth
    tchannel = KerasBackend.int_shape(inputs)[channel_axis] * t
    # Width
